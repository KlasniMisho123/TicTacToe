...
function handleClick() {
  ...
  $(".ttt-square").on("click", function () {
    ...
    if (!victory) {
      if (isXTurn) {
        if ($(squareElement).hasClass("x-class")) {
          // If the square already has the "x-class", do nothing
          return;
        } else {
          $(this).html("X");
        ...
        if ($(squareElement).hasClass("o-class")) {
          // If the square already has the "o-class", do nothing
          return;
        } else {
          $(this).html("O");
    ...
    // Disable clickability for the clicked square
    $(squareElement).off("click");
  });
}
